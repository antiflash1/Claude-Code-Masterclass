---
description: Create a feature spec file and a git brach from a given short idea
...
- An optional figma design note, if a figma design link is given as an argument.
